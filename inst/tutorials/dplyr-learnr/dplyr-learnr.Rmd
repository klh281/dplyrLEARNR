...
In the code chunks below, write your own code to practice with the `dplyr::filter()` function. If you get stuck, click on the "Hint" and/or "Solution" buttons.
...
```{r filter_q1-hint, warning = FALSE}
penguins %>%
